...
<section class="yorumlar" id="yorumlar">
  <h2 class="blok-baslik">Okur Yorumları <span class="soluk">(<?= count($comments) ?>)</span></h2>
  ...
  <form class="yorum-form" id="yorumForm" data-post="<?= (int)$post['id'] ?>">
    ...
    <p class="soluk kucuk">Yorumlar editör onayından sonra yayımlanır.</p>
  </form>
</section>
