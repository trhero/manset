<?php
/**
 * Yerel teması — e-bülten kayıt kutusu.
...
$bultenBaslik = isset($baslik) && $baslik !== ''
    ? $baslik
    : ($bolge !== '' ? $bolge . ' haberleri e-postanıza gelsin' : 'Bültene abone olun');
?>
<section class="kutu bulten-kutu">
  <h2 class="kutu-baslik"><?= esc($bultenBaslik) ?></h2>
  <p class="soluk kucuk">Günün öne çıkan yerel haberlerini gönderelim. İstediğiniz an çıkabilirsiniz.</p>
