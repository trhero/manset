<?php
/**
 * Gece teması — paylaş düğmeleri.
 * DIŞ API / SDK YOK: yalnız intent adresleri ve panoya kopyalama (theme.js).
 * Gece dili: mono etiket, koyu yüzey üzerinde neon çerçeveli çipler.
...
<div class="paylas" data-paylas>
  <span class="paylas-etiket mono">PAYLAŞ</span>
  <?php foreach ($baglantilar as $b): ?>
    ...
    <?php endif; ?>
  <?php endforeach; ?>
  <span class="paylas-sonuc mono" role="status" aria-live="polite"></span>
</div>
