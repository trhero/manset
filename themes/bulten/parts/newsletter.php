<?php
/**
 * Bülten teması — e-bülten kayıt kutusu.
 * Uç nokta: newsletter.subscribe (Ajan-9). Uç henüz kurulmamışsa form
 * kullanıcıya Türkçe hata mesajı gösterir; sayfa bozulmaz.
 */
if (!defined('MANSET_BOOTSTRAPPED')) { exit; }
$bultenBaslik = isset($baslik) && $baslik !== '' ? $baslik : 'Bültene abone olun';
?>
<section class="bulten-kutu">
  <h2 class="bolum-baslik"><?= esc($bultenBaslik) ?></h2>
  <p class="soluk">Günün öne çıkan haberlerini e-postanıza gönderelim. İstediğiniz an çıkabilirsiniz.</p>
