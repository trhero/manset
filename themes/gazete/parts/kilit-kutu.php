<?php
/**
 * Gazete teması — ölçülü ödeme duvarı kilit kutusu (1.2-05, Ajan-D).
 *
...
<style>
.olculu-kilit{border:1px solid var(--renk-cizgi,#e3e7ec);background:var(--renk-yuzey,#fff);border-radius:var(--kose,6px);padding:18px 20px;margin:20px 0}
...
.olculu-kilit .dugme{display:inline-block;background:var(--renk-ana,#c0392b);color:#fff;border:0;padding:9px 16px;border-radius:var(--kose,6px);font-size:14px;font-weight:600;cursor:pointer}
.olculu-kilit .dugme.ghost{background:transparent;color:var(--renk-metin,#1c1f23);border:1px solid var(--renk-cizgi,#e3e7ec)}
...
.olculu-kilit .soluk{color:var(--renk-soluk,#7b8794)}
</style>
